...
@section('body')
    ...
    <div class="wrapper" dir="rtl">
        <form action="{{route('birthRestriction.store')}}" method="POST" data-aos="zoom-in-down">
            @csrf
            <div class="form-header">
                <h2>طلب الحصول على شهادة ميلاد</h2>
            </div>
                    ...
                    <section class="sec">
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="form-holder">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="الاسم الأول" class="form-control" value="{{$user->req_fore_na}}" readonly name="" />
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="أسم الاب" class="form-control" value="{{$user->req_second_na}}" readonly name="" />
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" placeholder="أسم الجد" class="form-control" value="{{$user->req_third_na}}" readonly name="" />
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" placeholder="القب" class="form-control" value="{{$user->req_tit}}" readonly name="" />
                                    </div>
                                    <div class="col-sm-2 ">
                                        <select name="" id="" class="form-select">
                                            <option value="0" class="option">{{$user->nationality_req->nationality_na}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-lg-4 input-mar">
                                <select name="birth_type_id" id="birth_type_id" class="form-select">
                                    <option value="" class="option">نوع الولادة</option>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-lg-4 input-mar">
                                <select name="generated_id" id="generated_id" class="form-select">
                                    <option value="" class="option">صفة من قام بتوليد</option>
                            ...
                            <div class="col-lg-4 input-mar">
                                <select name="place_birth_id" id="place_birth_id" class="form-select">
                                    <option value="" class="option">مكان الولادة</option>
                                ...
                                <div class="row">
                                    <div class="col-sm-3 " >
                                        <select id="" class="form-select" readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>' >
                                            <option value="0" class="option"> {{$user->countrie_birth->countrie_na}}</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-3 " >
                                        <select id="" class="form-select" readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>'>
                                            <option value="0" class="option">{{$user->province_birth->na_prov}}</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-3 " >
                                        <select id="" class="form-select" readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>'>
                                            <option value="0" class="option">{{$user->directorate_pirth->na_dire}}</option>                                        
                                        </select>
                                    </div>
                                    <div class="col-sm-3">
                    ...
                    <section class="sec">
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="form-holder">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="الاسم الأول" class="form-control" value="{{$user->father_fore_na}}" readonly name="" />
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="أسم الاب" class="form-control" value="{{$user->father_second_na}}" readonly name="" />
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" placeholder="أسم الجد" class="form-control" value="{{$user->father_third_na}}" readonly name="" />
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" placeholder="القب" class="form-control" value="{{$user->father_tit}}" name="" readonly />
                                    </div>
                                    <div class="col-sm-2 ">
                                        <select name="" id="" class="form-select">
                                            <option value="0" class="option">{{$user->nationality_father->nationality_na}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-4">
                                <input type="date" name="date_pirth_Ad_father" id="date_pirth_Ad_father" class="form-control" />
                            </div>
                            <label for="" style="margin-right: 20px;">
                                تاريخ الميلاد الهجري:
                            </label>
                            <div class="col-sm-4">
                                <input type="text" name="date_pirth_hegira_father" id="date_pirth_hegira_father" class="form-control text-ignore-validation" />
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="form-holder">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="عزلة / قرية الميلاد" class="form-control" name="village_parth_father" id="village_parth_father" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="form-holder">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="عزلة / قرية" class="form-control" name="village_accomm_father" id="village_accomm_father" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <select name="profession_father_id" id="profession_father_id" class="form-select" required>
                                <option value="" class="option">المنهة</option>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-4">
                                <input type="number" placeholder="بالسنوات الكاملة" class="form-control" name="fath_age_first_marri" id="fath_age_first_marri" />
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="card_vers_cent_fath_id" id="card_vers_cent_fath_id" class="form-select" required>
                                            <option value="" class="option">جهة الاصدار</option>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" placeholder="الرقم الوطني" class="form-control cardid" name="card_id_fath" id="card_id_fath"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="sec">
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="form-holder">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="الاسم الأول" class="form-control" value="{{$user->mother_fore_na}}" readonly name="" />
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="أسم الاب" class="form-control" value="{{$user->mother_second_na}}" readonly name="" />
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" placeholder="أسم الجد" class="form-control" value="{{$user->mother_third_na}}" readonly name="" />
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" placeholder="القب" class="form-control" value="{{$user->mother_tit}}" name="" readonly />
                                    </div>
                                    <div class="col-sm-2 ">
                                        <select name="" id="" class="form-select">
                                            <option value="0" class="option">{{$user->nationality_mother->nationality_na}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-4">
                                <input type="date" name="date_pirth_ad_moth" id="date_pirth_ad_moth" class="form-control" />
                            </div>
                            <label for="" style="margin-right: 20px;">
                                تاريخ الميلاد الهجري:
                            </label>
                            <div class="col-sm-4">
                                <input type="text" name="date_pirth_he_moth" id="date_pirth_he_moth" class="form-control text-ignore-validation" />
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="form-holder">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="عزلة / قرية الميلاد" class="form-control" name="village_parth_moth" id="village_parth_moth" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="form-holder">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="عزلة / قرية" class="form-control" name="village_accomm_moth" id="village_accomm_moth" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-4">
                                <input type="number" placeholder="بالسنوات الكاملة" class="form-control" name="moth_age_first_marri" id="moth_age_first_marri"/>
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="form-holder">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" placeholder="الرقم الوطني" class="form-control cardid" name="card_id_moth" id="card_id_moth"/>
                                    </div>
                                </div>
                            </div>
                        </div>
