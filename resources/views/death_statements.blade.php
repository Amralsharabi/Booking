...
{{-- {{ $tooltip = "readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>'" }} --}}
    <div class="wrapper" dir="rtl" >
        <form action="{{route('deathStatement.store')}}" method="POST" data-aos="zoom-in-down">
            @csrf
            <!-- tab 0 -->
            <div  class="tab" id="tab-0" >
                <div class="form-header">
                    <h1 class="mb-4">طلب الحصول على شهادة وفاة</h1>
                </div>
                <div id="wizard" >
                    <div class="form-header">
                    ...
                    <div class="tooltip-demo">
                        ...
                        <div class="form-row" dir="rtl">
                                ...
                                <div class="form-holder">
                                    ...
                                    <div class="row ">
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="الاسم الأول" class="form-control " value="{!!$user->commondata->req_fore_na!!}" readonly data-bs-toggle="tooltip" data-bs-html="true"  readonly data-bs-toggle='tooltip' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>'/>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="أسم الاب" class="form-control" value="{{$user->commondata->req_second_na}}" readonly data-bs-toggle="tooltip" data-bs-html="true"  readonly data-bs-toggle='tooltip' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>'/>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="أسم الجد" class="form-control" value="{{$user->commondata->req_third_na}}"readonly data-bs-toggle="tooltip" data-bs-html="true" readonly data-bs-toggle='tooltip' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>'/>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="القب" class="form-control" value="{{$user->commondata->req_tit}}" readonly data-bs-toggle="tooltip" data-bs-html="true"  readonly data-bs-toggle='tooltip' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>'/>
                                    </div>
                                </div>	                        
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                                ...
                                <div class="form-holder">
                                    <div class="row">
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="الاسم الأول" class="form-control" value="{{$user->commondata->mother_fore_na}}" readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>' />
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="أسم الاب" class="form-control" value="{{$user->commondata->mother_second_na}}" readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>' />
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="أسم الجد" class="form-control" value="{{$user->commondata->mother_third_na}}" readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>' />
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="القب" class="form-control" value="{{$user->commondata->mother_tit}}" readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>' />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-5">
                                <input type="datetime-local" class="form-control" name="date_death" id="date_death"/>
                            </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-2">
                                <input type="text"  class="form-control cardid" name="card_No_decea" id="card_No_decea"/>
                            </div>
                            <label for="" style="margin-right: 20px;">
                                تاريخ الإصدار:
                            </label>
                            <div class="col-sm-2">
                                <input type="date"  class="form-control" name="date_card_issuance_dec" id="date_card_issuance_dec"/>
                            </div>
                            <label for="" style="margin-right: 20px;">
                                جهة الإصدار :
                            </label>
