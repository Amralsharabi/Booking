...
{{-- {{ $tooltip = "readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>'" }} --}}
    <div class="wrapper" dir="rtl" >
        <form action="{{route('FamilyCard.store')}}" method="POST" data-aos="zoom-in-down">
            @csrf
            <!-- tab 0 -->
            <div  class="tab" id="tab-0" >
                <div class="form-header">
                    <h1 class="mb-4">طلب الحصول على بطاقة عائلية</h1>
                </div>
                <div id="wizard" >
                    <div class="form-header">
                    ...
                    <div class="container">
                        <div class="alert alert-success alert-dismissible fade show py-10" role="alert" style="text-align:center ">
                            ...
                            <h3 class="mb-0">باستثناء ("الحالة الاجتماعية ، الحالة التعليمية ، اعلى شهادة ، التخصص ، المهنة ، جهة العمل ، العنوان")</h3>
                            <hr>
                    ...
                    <div class="tooltip-demo">
                                ...
                                <div class="form-holder">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="directorate_id" id="directorate_id" class="form-select" required data-bs-toggle='tooltip'  title='قم بإختيار عنصر من القائمة'>
                                            ...
                                            {{-- @foreach ($directorates as $card_version_center)
        
                                                <option value="{{$card_version_center->id}}" class="option">{{$card_version_center->na_dire}}</option>
                                    ...
                                    <div class="col-sm-3 " >
                                        <select name="blood_type_id" id="" class="form-select" required data-bs-toggle='tooltip'  title='قم بإختيار عنصر من القائمة'>
                                            ...
                                            @foreach ($blood_types as $blood_type)
                                                <option value="{{$blood_type->id}}" class="option">{{$blood_type->na_bloodty}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>	                        
                        ...
                        <div class="form-row" dir="rtl">
                                ...
                                <div class="form-holder">
                                    <div class="row">
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="الاسم الأول" class="form-control" value="{{$user->father_fore_na}}" readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>'/>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="أسم الاب" class="form-control" value="{{$user->father_second_na}}" readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>' />
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" placeholder="أسم الجد" class="form-control" value="{{$user->father_third_na}}" readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>'/>
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" placeholder="القب" class="form-control" value="{{$user->father_tit}}" readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>' />
                                    </div>
                                    <div class="col-sm-2 " >
                        ...
                        <div class="form-holder">
                            ...
                            <div class="col-sm-3">
                                <select name="countrie_accom_id" id="countrie_accom_id" class="form-select" data-bs-toggle='tooltip'  title='يمكنك التعديل على هذه البيانات'>
                                    <option value="{{$countrie_accom_id}}"  style="color: white" >{{$countrie_accom}} </option>
                                    {{-- @foreach ($countrie_nationalits as $countries_nationality)
                                        @if ($countries_nationality->id != $countrie_accom_id)
                                            <option value="{{$countries_nationality->id}}" class="option">{{$countries_nationality->countrie_na}}</option>
                                        @endif
                                    @endforeach --}}
                                </select>
                            </div>
                            <div class="col-sm-3">
                                <select name="province_accom_id" id="province_accom_id" class="form-select" data-bs-toggle='tooltip'  title='يمكنك التعديل على هذه البيانات'>
                                    <option value="{{$province_accom_id}}" style="color: white" class="option">{{$province_accom}}</option>                                        
                                    {{-- @foreach ($provinces as $province)
                                        @if ($province->id != $province_accom_id)
                            ...
                            <div class="col-sm-3 " >
                                <select name="directorate_accom_id" id="directorate_accom_id" class="form-select" data-bs-toggle='tooltip'  title='يمكنك التعديل على هذه البيانات'>
                                    ...
                                    {{-- @foreach ($directorates as $directorate)
                                        @if ($directorate->id != $countrie_accom_id)
                            ...
                            <div class="col-sm-3">
                                <input type="text" placeholder="عزلة / قرية" class="form-control" name="village_accom" value="{{$user->village_accom}}" required data-bs-toggle='tooltip'  title='يمكنك التعديل على هذه البيانات'/>
                            </div>
                            </div>

                            <div class="row">
                            <div class="col-sm-3">
                                <input type="text" placeholder="الحي" class="form-control" name="neigh_accom" value="{{$user->neigh_accom}}" required data-bs-toggle='tooltip'  title='يمكنك التعديل على هذه البيانات'/>
                            </div>
                            <div class="col-sm-3">
                                <input type="text" placeholder="الشارع" class="form-control text-ignore-validation" name="street_accom" value="{{$user->street_accom}}" required />
                            </div>
                            <div class="col-sm-3">
                                <input type="text" placeholder="المنزل" class="form-control text-ignore-validation" name="house_accom" value="{{$user->house_accom}}" required/>
                            </div>
                            <div class="col-sm-3">
                                <input type="tel" placeholder="رقم التلفون" class="form-control" name="num_phone" value="{{$user->num_phone}}" required/>
                            </div>
                            </div>
                        ...
                        <div class="form-holder">
                            ...
                            <div class="col-sm-3">
                                <select name="countrie_accom_form_id" id="countrie_accom_form_id" class="form-select" data-bs-toggle='tooltip'  title='يمكنك التعديل على هذه البيانات'>
                                    <option value=""  style="color: white" >دولة الاقامة السابقة</option>
                                    {{-- @foreach ($countrie_nationalits as $countries_nationality)
                                        @if ($countries_nationality->id != $countrie_accom_id)
                                            <option value="{{$countries_nationality->id}}" class="option">{{$countries_nationality->countrie_na}}</option>
                                        @endif
                            ...
                            <div class="col-sm-3">
                                <select name="province_acom_form_id" id="province_acom_form_id" class="form-select" data-bs-toggle='tooltip'  title='يمكنك التعديل على هذه البيانات'>
                                    <option value="" style="color: white" class="option">محافظة الاقامة السابقة</option>                                        
                                    {{-- @foreach ($provinces as $province)
                                        @if ($province->id != $province_accom_id)
                                            <option value="{{$province->id}}" class="option">{{$province->na_prov}}</option>
                                        @endif
                            ...
                            <div class="col-sm-3 " >
                                <select name="directorate_acom_form_id" id="directorate_acom_form_id" class="form-select" data-bs-toggle='tooltip'  title='يمكنك التعديل على هذه البيانات'>
                                    <option value="" class="option">مديرية الاقامة السابقة</option>
                                    {{-- @foreach ($directorates as $directorate)
                                        @if ($directorate->id != $countrie_accom_id)
                                            <option value="{{$directorate->id}}" class="option">{{$directorate->na_dire}}</option>
                                        @endif
                            ...
                            <div class="col-sm-3">
                                <input type="text" placeholder="عزلة / قرية" class="form-control" name="village_accomm_form" required data-bs-toggle='tooltip'  title='يمكنك التعديل على هذه البيانات'/>
                            </div>
                            </div>

                            <div class="row">
                            <div class="col-sm-3">
                                <input type="text" placeholder="الحي" class="form-control" name="neigh_accomm_form" required data-bs-toggle='tooltip'  title='يمكنك التعديل على هذه البيانات'/>
                            </div>
                            <div class="col-sm-3">
                                <input type="text" placeholder="الشارع" class="form-control text-ignore-validation" name="street_accomm_form" required />
                            </div>
                            <div class="col-sm-3">
                                <input type="text" placeholder="المنزل" class="form-control text-ignore-validation" name="house_accom_form" required/>
                            </div>
                            <div class="col-sm-3">
                                <input type="tel" placeholder="رقم التلفون" class="form-control" name="phone" required/>
                            </div>
                            </div>
                    ...
                    <div class="form-row" dir="rtl">
                        ...
                        <div class="form-holder">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <input type="date" class="form-control" value="" name="date_version" id="date_version" required/>
                                </div>
                    ...
                    <div class="tooltip-demo">
                        ...
                        <div class="form-row" dir="rtl">
                                ...
                                <div class="form-holder">
                                    <div class="row">
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="الاسم الأول" class="form-control" name="foreNa_witn" required data-bs-toggle='tooltip'  title='هذ الحقل مخصص لاسم واحد فقط بالغة العربية ولايسمح بإدخال مسافة'/>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="أسم الاب" class="form-control" name="secondNa_witn" required data-bs-toggle='tooltip'  title='هذ الحقل مخصص لاسم واحد فقط بالغة العربية ولايسمح بإدخال مسافة'/>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="أسم الجد" class="form-control" name="thirdNa_witn" required data-bs-toggle='tooltip'  title='هذ الحقل مخصص لاسم واحد فقط بالغة العربية ولايسمح بإدخال مسافة'/>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="القب" class="form-control" name="tit_witn" required data-bs-toggle='tooltip'  title='هذ الحقل مخصص لاسم واحد فقط بالغة العربية ولايسمح بإدخال مسافة'/>
                                    </div>
                                </div>	                        
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-3">
                                <select name="jihat_work_id" id="" class="form-select" required data-bs-toggle='tooltip'  title='يرجى إختيار عنصر من القائمة'>
                            ...
                            <label for="" style="margin-right: 20px;">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" placeholder="مقر العمل" class="form-control" name="work_head_witn" required data-bs-toggle='tooltip' title='هذ الحقل خاص بمقر العمل يسمح بإدخال الاحرف العربية فقط '/>
                                </div>
                            <label for="" style="margin-right: 20px;">
                                التلفون:
                            </label>
                                <div class="col-sm-2">
                                    <input type="tel" placeholder="رقم التلفون" class="form-control" name="phone_witn" required data-bs-toggle='tooltip' title='هذا الحقل خاص برقم التلفون لايمكنك ادخال غير الارقم'/>
                                </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            <label for="">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control cardid" placeholder="رقم الــبــطاقـة" name="card_id" required data-bs-toggle='tooltip'  title='يرجى الانتباه هذا الحقل مخصص لرقم البطاقة الشخصية '/>
                                </div>
                                <label for="" style="margin-right: 20px;">
                                    محل الاصدار:
                                </label>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-4">
                                <input type="date" class="form-control" name="date_card_issuance" required data-bs-toggle='tooltip'  title='يرجى تحديد تاريخ اصدار البطاقة'/>
                            </div>
                            <label for="" style="margin-right: 20px;">
                                الـــعــنــوان:
                            </label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="address_witn" required data-bs-toggle='tooltip'  title='هذ الحقل مخصص للعنوان يسمح بالغة العربية فقط '/>
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="form-holder">
                                <div class="row">
                                <div class="col-sm-3">
                                    <input type="text" placeholder="الاسم الأول" class="form-control" name="foreNa_witn2" required data-bs-toggle='tooltip'  title='هذ الحقل مخصص لاسم واحد فقط بالغة العربية ولايسمح بإدخال مسافة'/>
                                </div>
                                <div class="col-sm-3">
                                    <input type="text" placeholder="أسم الاب" class="form-control" name="secondNa_witn2" required data-bs-toggle='tooltip'  title='هذ الحقل مخصص لاسم واحد فقط بالغة العربية ولايسمح بإدخال مسافة'/>
                                </div>
                                <div class="col-sm-3">
                                    <input type="text" placeholder="أسم الجد" class="form-control" name="thirdNa_witn2" required data-bs-toggle='tooltip'  title='هذ الحقل مخصص لاسم واحد فقط بالغة العربية ولايسمح بإدخال مسافة'/>
                                </div>
                                <div class="col-sm-3">
                                    <input type="text" placeholder="القب" class="form-control" name="tit_witn2" required data-bs-toggle='tooltip'  title='هذ الحقل مخصص لاسم واحد فقط بالغة العربية ولايسمح بإدخال مسافة'/>
                                </div>
                            </div>	                        
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-3">
                                <select name="jihat_work_id2" id="" class="form-select" required data-bs-toggle='tooltip'  title='يرجى إختيار عنصر من القائمة'>
                                    <option value="" class="option">جهة العمل </option>
                                    @foreach ($jihat_works as $jihat_work)
                            ...
                            <label for="" style="margin-right: 20px;">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" placeholder="مقر العمل" class="form-control" name="work_head_witn2" required data-bs-toggle='tooltip' title='هذ الحقل خاص بمقر العمل يسمح بإدخال الاحرف العربية فقط'/>
                                </div>
                            <label for="" style="margin-right: 20px;">
                                التلفون:
                            </label>
                                <div class="col-sm-2">
                                    <input type="tel" placeholder="رقم التلفون" class="form-control" name="phone_witn2" required data-bs-toggle='tooltip' title='هذا الحقل خاص برقم التلفون لايمكنك ادخال غير الارقم'/>
                                </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            <label for="">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control cardid" placeholder="رقم الــبــطاقـة" name="card_id2" required data-bs-toggle='tooltip'  title='يرجى الانتباه هذا الحقل مخصص لرقم البطاقة الشخصية '/>
                                </div>
                                <label for="" style="margin-right: 20px;">
                                    محل الاصدار:
                                </label>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-4">
                                <input type="date" class="form-control" name="date_card_issuance2" required data-bs-toggle='tooltip'  title='يرجى تحديد تاريخ اصدار البطاقة'/>
                            </div>
                            <label for="" style="margin-right: 20px;">
                                الـــعــنــوان:
                            </label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="address_witn2" required data-bs-toggle='tooltip'  title='هذ الحقل مخصص للعنوان يسمح بالغة العربية فقط '/>
                            </div>
                        </div>
                        <hr size="5" class="hr-m"/>
                    </div>
