...
{{-- {{ $tooltip = "readonly data-bs-toggle='tooltip' data-bs-html='true' title=' لا يمكنك تعديل هذه البيانات للمزيد قم بدخول الى صفحة <a href=``>المساعدة</a>'" }} --}}
    <div class="wrapper" dir="rtl" >
        <form action="{{route('update.card.pers',encrypt($cardPersonaNew->id))}}" method="POST" data-aos="zoom-in-down">
            @csrf
            <!-- tab 0 -->
            <div  class="tab" id="tab-0" >
                <div class="form-header">
                    <h1 class="mb-4">تعديل طلب الحصول على بطاقة شخصية</h1>
                </div>
                <div id="wizard" >
                    <div class="form-header">
                ...
                <section class="sec">
                    <div class="tooltip-demo">
                        ...
                        {{-- <div class="form-row" >
                            ...
                            <div class="col-sm-3">
                                <select name="province_id" id="" class="form-select" required data-bs-toggle='tooltip'  title='قم بإختيار عنصر من القائمة'>
                            ...
                            <div class="col-sm-3" >
                                <select name="directorate_id" id="" class="form-select" required data-bs-toggle='tooltip'  title='قم بإختيار عنصر من القائمة'>
