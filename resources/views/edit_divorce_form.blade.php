...
@section('body')
    <div class="wrapper" dir="rtl" >
        <form action="{{route('logDivorce.update',encrypt($log_divorce->id))}}" method="POST" data-aos="zoom-in-down">
            @csrf
            @method('GET')
                ...
                <div id="wizard">
                    <section class="sec">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <select name="province_id" id="province_id" class="form-select" required data-bs-toggle='tooltip'  title='قم بإختيار عنصر من القائمة'>
                                            <option value="{{$log_divorce->province->id}}" class="option">{{$log_divorce->province->na_prov}}</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-4">
                                        <select name="directorate_id" id="directorate_id" class="form-select" required data-bs-toggle='tooltip'  title='قم بإختيار عنصر من القائمة'>
                                            <option value="{{$log_divorce->directorate->id}}" class="option">{{$log_divorce->directorate->na_dire}}</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-4">
                                        <select name="center_id" id="center_id" class="form-select" required data-bs-toggle='tooltip'  title='قم بإختيار عنصر من القائمة'>
                                            <option value="{{$log_divorce->center->id}}" class="option">{{$log_divorce->center->na_center}}</option>
                                        </select>
                                    </div>
                                </div>	                        
                            </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-4">
                                <input type="date" value="{{$log_divorce->date_contract_ad}}" name="date_contract_ad" id="date_contract_ad" class="form-control" />
                            </div>
                            <label for="" style="margin-right: 20px;">
                                تاريخ الطلاق الهجري:
                            </label>
                            <div class="col-sm-4">
                                <input type="text" value="{{$log_divorce->date_contract_he}}" name="date_contract_he" id="date_contract_he" class="form-control text-ignore-validation" />
                            </div>
                        </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <select class="form-select" name="province_contract_id" id="province_contract_id">
                                        <option value="{{$log_divorce->provincecontract->id}}" class="option">{{$log_divorce->provincecontract->na_prov}}</option>
                                    </select>
                                </div>
                            </div>
                            <label for="" style="margin-right: 20px;">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <select class="form-select" name="directorate_contract_id" id="directorate_contract_id">
                                        <option value="{{$log_divorce->directoratecontract->id}}" class="option">{{$log_divorce->directoratecontract->na_dire}}</option>
                                    </select>
                                </div>
                            </div>
                            <label for="" style="margin-right: 20px;">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <select class="form-select" name="divor_type" id="divor_type">
                                        @if ($log_divorce->divor_type == 1)
                                            <option class="octicon" value="1" selected>نافذ</option>
                                            <option class="octicon" value="2">رجعي</option>
                                        @else
                                            <option class="octicon" value="1">نافذ</option>
                                            <option class="octicon" value="2" selected>رجعي</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-9">
                                <div class="form-group">
                                    <input type="text" value="{{$log_divorce->divorce_reason}}" name="divorce_reason" id="divorce_reason" style="width: 100%; height: 50px; background-color: #ffffff99;border: 1px solid rgb(0, 179, 255);text-align: center;padding: 8px;color:black"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="form-holder">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="number" value="{{$log_divorce->no_births_levi_husw_male}}" placeholder="ذكور" class="form-control" name="no_births_levi_husw_male" id="no_births_levi_husw_male" />
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="number" value="{{$log_divorce->no_births_levi_husw_fem}}" placeholder="اناث" class="form-control" name="no_births_levi_husw_fem" id="no_births_levi_husw_fem" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="form-holder">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="number" value="{{$log_divorce->no_births_live_wife_male}}" placeholder="ذكور" class="form-control" name="no_births_live_wife_male" id="no_births_live_wife_male" />
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="number" value="{{$log_divorce->no_births_live_wife_fem}}" placeholder="اناث" class="form-control" name="no_births_live_wife_fem" id="no_births_live_wife_fem" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-3">
                                <input type="date" value="{{$log_divorce->date_marriage}}" name="date_marriage" id="date_marriage" class="form-control" />
                            </div>
                            <label for="" style="margin-right: 20px;">
                                تاريخ الزواج الهجري:
                            </label>
                            <div class="col-sm-3">
                                <input type="text" value="{{$log_divorce->date_marriage_hj}}" name="date_marriage_hj" id="date_marriage_hj" class="form-control text-ignore-validation" />
                            </div>
                            <label for="" style="margin-right: 20px;">
                                حالة المطلقة:
                            </label>
                            <div class="col-sm-3">
                                <select name="status_wife_after_divo" id="status_wife_after_divo" class="form-select" required>
                                    @if ($log_divorce->status_wife_after_divo == 1)
                                        <option value="1" class="option" selected>حامل</option>
                                    ...
                                    @elseif ($log_divorce->status_wife_after_divo == 2)
                                        <option value="1" class="option">حامل</option>
                                        <option value="2" class="option" selected>غير معروف</option>
                                        <option value="3" class="option">مرضع</option>
                                        <option value="4" class="option">لايوجد حمل</option>
                                    @elseif ($log_divorce->status_wife_after_divo == 3)
                                        <option value="1" class="option">حامل</option>
                                        <option value="2" class="option">غير معروف</option>
                                        <option value="3" class="option" selected>مرضع</option>
                                        <option value="4" class="option">لايوجد حمل</option>
                                    @elseif ($log_divorce->status_wife_after_divo == 4)
                                        <option value="1" class="option">حامل</option>
                                        <option value="2" class="option">غير معروف</option>
                                        <option value="3" class="option">مرضع</option>
                                        <option value="4" class="option" selected>لايوجد حمل</option>
                                    @endif
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row" dir="rtl">
                            ...
                            <div class="col-sm-3">
                                <input type="text" value="{{$log_divorce->Court_na}}" name="Court_na" id="Court_na" class="form-control" />
                            </div>
                            <label for="" style="margin-right: 20px;">
                                رقم الوثيقة:
                            </label>
                            <div class="col-sm-3">
                                <input type="number" value="{{$log_divorce->document_no}}" name="document_no" id="document_no" class="form-control" />
                            </div>
                            <label for="" style="margin-right: 20px;">
                                تاريخ الوثيقة:
                            </label>
                            <div class="col-sm-3">
                                <input type="date" value="{{$log_divorce->date_document}}" name="date_document" id="date_document" class="form-control" />
                            </div>
                        </div>
                        <hr size="5" class="hr-m"/>
                    </section>
