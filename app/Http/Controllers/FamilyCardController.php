...
class FamilyCardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('‏‏form_card_family',compact(
            'user',
            'nationality_req',
            'nationality_father',
            'nationality_mother',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $card->countrie_accom_form_id = request('countrie_accom_form_id');
            $card->province_acom_form_id = request('province_acom_form_id');
            $card->directorate_acom_form_id = request('directorate_acom_form_id');
            $card->village_accomm_form = request('village_accomm_form');
            $card->neigh_accomm_form = request('neigh_accomm_form');
            $card->street_accomm_form = request('street_accomm_form');
            $card->house_accom_form = request('house_accom_form');
    ...
    public function show($encryptedId)
    {
        ...
        return view('show_form_card_family_new',compact(
            'id',
            'FamilyCard',
            'common_data',
            'dataWitnesse',
    ...
    public function edit($encryptedId)
    {
        ...
        return view('edit_form_card_family_new',compact(
            'FamilyCard',
            'provinces',
            'directorates',
            'blood_types',
    ...
    public function update(Request $request, $encryptedId)
    {
        ...
        try {
            $FamilyCard = FamilyCard::findOrFail($id);
            $FamilyCard->province_id = request('province_id');
            $FamilyCard->directorate_id = request('directorate_id');
            $FamilyCard->center_id = request('center_id');
            $FamilyCard->blood_type_id = request('blood_type_id');
            $FamilyCard->countrie_accom_form_id = request('countrie_accom_form_id');
            $FamilyCard->province_acom_form_id = request('province_acom_form_id');
            $FamilyCard->directorate_acom_form_id = request('directorate_acom_form_id');
            $FamilyCard->village_accomm_form = request('village_accomm_form');
            $FamilyCard->neigh_accomm_form = request('neigh_accomm_form');
            $FamilyCard->street_accomm_form = request('street_accomm_form');
            $FamilyCard->house_accom_form = request('house_accom_form');
            $FamilyCard->phone = request('phone');
            $FamilyCard->date_version = request('date_version');
            $FamilyCard->card_version_center_id = request('card_version_center_id');
            $FamilyCard->save();
