        ...
        if(CardPersonaNew::where('user_id', Auth::id())->count()){
            $now = Carbon::now();
                ...
                if($remainingTime == '00:00:00'){
                    ...
                    return redirect()->route('home')->with('warning', "لقد تجاوزت عدد الطلبات المسموح لك بها اليوم للبطاقة الشخصية جديد يمكنك المحاولة بعد:  $remainingTime");
            }
                return $next($request);
